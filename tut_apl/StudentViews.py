...
from tut_apl.models import CustomUser, Students, AttendanceReport, Attendance, Subjects, StudentResult, LeaveReportStudent, StudentNote, FeedBackStudent, Courses
