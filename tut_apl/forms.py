...
from tut_apl.models import Courses, SessionYearModel
...
class RegStudentForm(forms.Form):
    first_name = forms.CharField(label="First Name",max_length=50, widget=forms.TextInput(attrs={"class":"form-control uppercase","placeholder":"First Name"}))
    ...
    phone = forms.CharField( widget=forms.NumberInput(attrs={"class":"form-control","placeholder":"Phone Number","id":"phone"}))
